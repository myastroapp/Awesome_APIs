...
+ [SnapAPI](https://snap.michaelcli.com) - REST API for website screenshots, metadata extraction, text extraction, and PDF generation. Free tier with 50 requests/month.
